...
{
    public class GetBanuLogTransactionsQuery :IRequest<IDataResult<PrivPagingResult<BanuLog>>>
    {
        public int Page { get; set; }
        public string Type { get; set; }
        public int PageSize { get; set; }
        public class GetBanuLogTransactionsQueryHandler : IRequestHandler<GetBanuLogTransactionsQuery, IDataResult<PrivPagingResult<BanuLog>>>

        {
            private readonly IBanuLogRepository _banuLogRepository;
            private readonly IMediator _mediator;

            public GetBanuLogTransactionsQueryHandler(IBanuLogRepository banuLogRepository, IMediator mediator)
            {
