        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactorFullName = table.Column<string>(type: "text", nullable: true),
                    TransactorId = table.Column<int>(type: "integer", nullable: false),
                    TransactionsDescription = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitorFullName = table.Column<string>(type: "text", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReqLimit = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_Email_MinLength", "LEN(Email) >= 10");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionType = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitorFullName = table.Column<string>(type: "text", nullable: true),
                    VisitorLicensePlate = table.Column<string>(type: "text", nullable: true),
                    VehicleEntry = table.Column<bool>(type: "boolean", nullable: false),
                    MultiPersonVisit = table.Column<bool>(type: "boolean", nullable: false),
                    IsConfirm = table.Column<bool>(type: "boolean", nullable: false),
                    IsExit = table.Column<bool>(type: "boolean", nullable: false),
                    Status = table.Column<bool>(type: "boolean", nullable: false),
                    ReasonForRejection = table.Column<string>(type: "text", nullable: true),
                    IsReject = table.Column<bool>(type: "boolean", nullable: true),
                    ...
                    VisitStartDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    VisitEndDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
